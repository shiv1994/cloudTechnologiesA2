 ...
 */
class PatchRouteFilterRule extends models['SubResource'] {
  /**
   * Create a PatchRouteFilterRule.
  ...
  /**
   * Defines the metadata of PatchRouteFilterRule
   *
   * @returns {object} metadata of PatchRouteFilterRule
   *
   */
  mapper() {
    return {
...
module.exports = PatchRouteFilterRule;
